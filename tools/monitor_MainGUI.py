...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.cmd.setItemText(7, _translate("MainWindow", "SET_RAMPSIGN set variable \'dacStepSign\' to 0 or 1"))
        self.cmd.setItemText(8, _translate("MainWindow", "SET_NUMT6TRIG set the \'numt6tick\' value"))
        self.cmd.setItemText(9, _translate("MainWindow", "SET_DACSTEP set variables \'dacStep\'"))
        self.cmd.setItemText(10, _translate("MainWindow", "SET_MODEDBG (debug command) set theMode"))
        self.cmd.setItemText(11, _translate("MainWindow", "SET_TESTPIN set TestPin to 0 or 1"))
        self.cmd.setItemText(12, _translate("MainWindow", "SET_DACMODE set DAC mode (unipolar [0] or bipolar [1])"))
        self.cmd.setItemText(13, _translate("MainWindow", "SET_DACTO0 set DAC output to zero"))
        self.cmd.setItemText(14, _translate("MainWindow", "SET_FTRIG set variable \'stopTrigADC\'"))
        self.cmd.setItemText(15, _translate("MainWindow", "SET_ZTRIG set variable \'stopTrigDAC\'"))
        self.cmd.setItemText(16, _translate("MainWindow", "SET_TRIGGERS set which stopTriggers must be used"))
        self.cmd.setItemText(17, _translate("MainWindow", "START_MODSAFE start an operating mode in a safe way"))
        self.cmd.setItemText(18, _translate("MainWindow", "SET_SETPOINT set control setpoint"))
        self.cmd.setItemText(19, _translate("MainWindow", "SET_PGAIN set control P gain"))
        self.cmd.setItemText(20, _translate("MainWindow", "SET_IGAIN set control I gain"))
        self.cmd.setItemText(21, _translate("MainWindow", "SET_DGAIN set control D gain"))
        self.cmd.setItemText(22, _translate("MainWindow", "KILL kills the epizmq program"))
